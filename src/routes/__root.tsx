...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free job portal connecting unemployed students and scholars with companies hiring freshers." },
      { name: "author", content: "ScholarHire" },
      { property: "og:title", content: "ScholarHire — Jobs for Unemployed Students & Scholars" },
      { property: "og:description", content: "Free job portal for students and scholars looking for their first break." },
